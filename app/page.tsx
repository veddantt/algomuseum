        ...
        {bootPhase === 2 && (
          ...
          >
            ...
            <motion.div
              ...
              className="flex justify-center w-full mb-24"
            >
              <Link 
                href="/museum" 
                className="group relative px-10 py-5 rounded-2xl bg-white text-black font-black uppercase tracking-tighter transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(255,255,255,0.15)] overflow-hidden"
              >
            ...
            >
              {[
                ...
                <GlassPanel key={i} intensity="light" interactive className="p-6 text-left flex flex-col gap-4 group">
